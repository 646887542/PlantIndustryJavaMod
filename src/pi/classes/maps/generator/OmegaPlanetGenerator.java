package pi.classes.maps.generator;
//代码来自https://github.com/RouterXdd/Icicle-World/blob/master/src/ice/classes/maps/generator/RkiSurfaceGenerator.java
...
public class OmegaPlanetGenerator extends PlanetGenerator {
    public float heightScl = 0.9f, octaves = 8, persistence = 0.7f, heightPow = 3f, heightMult = 1.6f;

    public Block[] terrain = {Blocks.grass, Blocks.moss, Blocks.moss,Blocks.darksand, Blocks.moss, Blocks.water,
            Blocks.ice, Blocks.sporeMoss, Blocks.snow, Blocks.darksand, Blocks.darksand, Blocks.water,
            Blocks.water, Blocks.snow, Blocks.ice, Blocks.sand, Blocks.sand, Blocks.grass, Blocks.grass,
    };
